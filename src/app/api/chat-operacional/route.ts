...
const operacionalColetarMotivoInstruction = `Analise o motivo relatado e os avisos disponíveis seguindo as instruções do sistema. IMPORTANTE: VOCÊ DEVE retornar APENAS uma destas opções sem explicar nada além disso:
...
export async function POST(req: NextRequest) {
  return handleChatRequest(req, {
    ...
    hasInicioFlow: true,
    coletarMotivoInstruction: operacionalColetarMotivoInstruction,
  })
}
