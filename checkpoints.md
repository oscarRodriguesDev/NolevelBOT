...
- PED-028: IA corporativa no webhook-corporativo (24/06/2026)
  ...
  - Commit: `a895a7c`
  - Push: ✅
- PED-029: Bloqueio inteligente de chamados repetitivos no webhook-corporativo (24/06/2026)
  - `verificarChamadosAbertos` substituida por `verificarChamadoRelacionado(cpf, motivo)` com analise IA
  - Usuario descreve o problema, IA compara com chamados abertos
  - So bloqueia se for relacionado; assuntos diferentes sao liberados
  - Build: ✅ sucesso
